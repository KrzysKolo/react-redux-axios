  ...
  return (
   ...
   <WrapperInfoSection>
    ...
    <InfoH2>Contact:</InfoH2>
      <InfoH3> <FontAwesomeIcon icon={faEnvelope} style={{color: '#3f51b5', fontSize: '1.2rem'}}/> {user.email}</InfoH3>
      <InfoH3> <FontAwesomeIcon icon={faPhoneSquare}/> {user.phone}</InfoH3>
    </WrapperInfoDiv>
